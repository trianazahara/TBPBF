...
function RatingItem(props) {
  ...
  const container = (0, import_jsx_runtime37.jsx)(RatingIcon, {
  ...
  return (0, import_jsx_runtime37.jsxs)(React50.Fragment, {
    children: [(0, import_jsx_runtime37.jsxs)(RatingLabel, {
      ownerState: {
        ...ownerState,
...
var Rating = React50.forwardRef(function Rating2(inProps, ref) {
  ...
  return (0, import_jsx_runtime37.jsxs)(RatingRoot, {
    as: component,
    ref: handleRef,
    ...
    children: [Array.from(new Array(max2)).map((_, index) => {
      ...
      if (precision < 1) {
        ...
        return (0, import_jsx_runtime37.jsx)(RatingDecimal, {
...
var SpeedDial = React54.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  return (0, import_jsx_runtime41.jsxs)(SpeedDialRoot, {
    className: clsx_default(classes.root, className),
    ref,
    role: "presentation",
    onKeyDown: handleKeyDown,
...
//# sourceMappingURL=chunk-BMXPLZ35.js.map
