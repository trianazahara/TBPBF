import {
  ...
  createPopper,
  usePagination
} from "./chunk-BMXPLZ35.js";
import {
  capitalize_default,
  isMuiElement_default,
  memoTheme_default,
  useId_default
} from "./chunk-RVHESJXL.js";
import {
  require_react_dom
} from "./chunk-KDCVS43I.js";
import {
  useDefaultProps
} from "./chunk-4U7PH6NW.js";
import {
  useThemeProps
} from "./chunk-UAOPXLUW.js";
import {
  CacheProvider,
  Global,
  StyleSheet,
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React35.useLayoutEffect : React35.useEffect;
...
function useGlobalId(idOverride) {
  const [defaultId, setDefaultId] = React36.useState(idOverride);
...
var Badge = React46.forwardRef(function Badge2(props, forwardedRef) {
  const {
    badgeContent: badgeContentProp,
    children,
...
var Button = React48.forwardRef(function Button2(props, forwardedRef) {
  const {
    action,
    children,
    disabled,
...
function ClickAwayListener(props) {
  ...
  return React49.cloneElement(children, childrenProps);
}
...
var DropdownContext = React50.createContext(null);
if (true) {
...
function useStateChangeDetection(parameters) {
  ...
  const internalPreviousStateRef = React51.useRef(initialState);
  React51.useEffect(() => {
...
function useControllableReducer(parameters) {
  const lastActionRef = React51.useRef(null);
  const {
    reducer,
    initialState,
  ...
  const controlledPropsRef = React51.useRef(controlledProps);
  if (true) {
    React51.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
  ...
  const reducerWithControlledState = React51.useCallback((state, action) => {
    lastActionRef.current = action;
    const controlledState = getControlledState(state, controlledProps);
    const newState = reducer(controlledState, action);
    return newState;
  }, [controlledProps, reducer]);
  const [nextState, dispatch] = React51.useReducer(reducerWithControlledState, initialState);
  const dispatchWithContext = React51.useCallback((action) => {
    dispatch({
      ...action,
...
function useDropdown(parameters = {}) {
  ...
  const [popupId, setPopupId] = React52.useState("");
  const [triggerElement, setTriggerElement] = React52.useState(null);
  const lastActionType = React52.useRef(null);
  const handleStateChange = React52.useCallback((event, field, value, reason) => {
    if (field === "open") {
      onOpenChange == null ? void 0 : onOpenChange(event, value);
    }
    lastActionType.current = reason;
  }, [onOpenChange]);
  const controlledProps = React52.useMemo(() => openProp !== void 0 ? {
    open: openProp
  } : {}, [openProp]);
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime9.jsxs)(React54.Fragment, {
...
var FormControl = React56.forwardRef(function FormControl2(props, forwardedRef) {
  const {
    defaultValue,
    children,
    disabled = false,
  ...
  React56.useEffect(() => setFocused((isFocused) => disabled ? false : isFocused), [disabled]);
  const ownerState = {
    ...props,
    disabled,
    error,
...
function useFormControlContext() {
  return React57.useContext(FormControlContext);
}
...
var Input = React59.forwardRef(function Input2(props, forwardedRef) {
  const {
...
function useTextNavigation(callback) {
  ...
  return React60.useCallback((event) => {
...
function useList(params) {
  ...
  const handleHighlightChange = React61.useCallback((event, value, reason) => {
    var _a;
  ...
  const stateComparers = React61.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React61.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React61.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React61.useMemo(() => ({
  ...
  const previousItems = React61.useRef([]);
  React61.useEffect(() => {
  ...
  const getItemState = React61.useCallback((item) => {
...
function useListItem(parameters) {
  ...
  const createHandleClick = React63.useCallback((externalHandlers) => (event) => {
    var _a;
  ...
  const createHandlePointerOver = React63.useCallback((externalHandlers) => (event) => {
    var _a;
...
var CompoundComponentContext = React64.createContext(null);
if (true) {
...
function useCompoundParent() {
  const [subitems, setSubitems] = React64.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React64.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React64.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React64.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React64.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React64.useCallback(function getItemIndex2(id) {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = React66.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT;
...
var Portal = React69.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React69.useState(null);
  const handleRef = useForkRef2(React69.isValidElement(children) ? getReactElementRef2(children) : null, forwardedRef);
  useEnhancedEffect_default2(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React69.isValidElement(children)) {
      ...
      return React69.cloneElement(children, newProps);
    }
    return children;
  }
...
var TransitionContext = React70.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React71.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React72.useState(true);
  const hasPendingExitTransition = React72.useRef(false);
  const registeredTransitions = React72.useRef(0);
  const [hasTransition, setHasTransition] = React72.useState(false);
  const previousRequestEnter = React72.useRef(requestEnter);
  React72.useEffect(() => {
  ...
  const handleExited = React72.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React72.useCallback(() => {
...
var PopupContext = React73.createContext(null);
if (true) {
...
var Popup = React74.forwardRef(function Popup2(props, forwardedRef) {
  ...
  const popupContextValue = React74.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React75.forwardRef(function Menu2(props, forwardedRef) {
  const {
    actions,
    anchor: anchorProp,
    children,
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React76.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React77.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    label,
...
function useMenuItem(params) {
  ...
  const itemRef = React78.useRef(null);
  const itemMetadata = React78.useMemo(() => ({
    disabled,
    id: id ?? "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = React78.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  const listContext = React79.useContext(ListContext);
  if (!listContext) {
...
var InnerMenuItem = React80.memo(React80.forwardRef(function MenuItem(props, forwardedRef) {
  const {
    children,
    disabled: disabledProp = false,
    label,
...
var MenuItem2 = React80.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function handleContainer(containerInfo, props) {
  ...
  if (!props.disableScrollLock) {
    if (isOverflowing(container)) {
      const scrollbarSize = getScrollbarSize2(ownerWindow2(container));
      restoreStyle.push({
...
function useModal(parameters) {
  ...
  const modal = React81.useRef({});
  const mountNodeRef = React81.useRef(null);
  const modalRef = React81.useRef(null);
  const handleRef = useForkRef2(modalRef, rootRef);
  const [exited, setExited] = React81.useState(!open);
  ...
  const isTopModal = React81.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var Modal = React82.forwardRef(function Modal2(props, forwardedRef) {
  const {
    children,
    closeAfterTransition = false,
    container,
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React84.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React84.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const controlledState = React84.useMemo(() => ({
    value: valueProp
  }), [valueProp]);
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React84.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React85.forwardRef(function NumberInput2(props, forwardedRef) {
  const {
    className,
    defaultValue,
    disabled,
...
var OptionGroup = React86.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {},
...
function useOption(params) {
  ...
  const selectOption = React87.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
function useOptionContextStabilizer(value) {
  const listContext = React88.useContext(ListContext);
  if (!listContext) {
  ...
  const localGetItemState = React88.useCallback((itemValue) => {
    if (itemValue !== value) {
  ...
  const localContextValue = React88.useMemo(() => ({
    dispatch,
    getItemState: localGetItemState
  }), [dispatch, localGetItemState]);
  return {
...
var InnerOption = React89.forwardRef(function InnerOption2(props, forwardedRef) {
  var _a, _b;
  const {
    children,
    disabled = false,
  ...
  const Root = slots.root ?? "li";
  const optionRef = React89.useRef(null);
...
var InnerOptionMemo = React89.memo(InnerOption);
var Option = React89.forwardRef(function Option2(props, ref) {
  const {
    value
  } = props;
  const {
...
var PopperTooltip = React90.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const tooltipRef = React90.useRef(null);
  const ownRef = useForkRef2(tooltipRef, forwardedRef);
  const popperRef = React90.useRef(null);
  const handlePopperRef = useForkRef2(popperRef, popperRefProp);
  const handlePopperRefRef = React90.useRef(handlePopperRef);
  useEnhancedEffect_default2(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React90.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React90.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React90.useState(resolveAnchorEl(anchorEl));
  React90.useEffect(() => {
...
var Popper = React90.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
function useSelect(props) {
  ...
  const optionValues = React91.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React91.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React91.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    return (option == null ? void 0 : option.disabled) ?? false;
  }, [getOptionByValue]);
  const stringifyOption = React91.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const getItemId = React91.useCallback((itemValue) => {
    var _a;
    return (_a = options.get(itemValue)) == null ? void 0 : _a.id;
  }, [options]);
  const handleSelectionChange = React91.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React91.useCallback((event, newValue) => {
    onHighlightChange == null ? void 0 : onHighlightChange(event, newValue ?? null);
  }, [onHighlightChange]);
  const handleStateChange = React91.useCallback((event, field, fieldValue) => {
    var _a;
    if (field === "open") {
  ...
  const getItemDomElement = React91.useCallback((itemId) => {
    var _a;
    if (itemId == null) {
      return null;
    }
  ...
  const isInitiallyOpen = React91.useRef(open);
  useEnhancedEffect_default2(() => {
    var _a;
  ...
  const getOptionMetadata = React91.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
...
function defaultRenderValue(selectedOptions) {
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime23.jsx)(React93.Fragment, {
...
var Select = React93.forwardRef(function Select2(props, forwardedRef) {
  const {
    areOptionsEqual,
    autoComplete,
    autoFocus,
  ...
  const [buttonDefined, setButtonDefined] = React93.useState(false);
  const buttonRef = React93.useRef(null);
  const listboxRef = React93.useRef(null);
  const Button3 = slots.root ?? "button";
  const ListboxRoot = slots.listbox ?? "ul";
  const PopupComponent = slots.popup ?? "div";
  const handleButtonRefChange = React93.useCallback((element) => {
  ...
  return (0, import_jsx_runtime23.jsxs)(React93.Fragment, {
...
var Slider = React95.forwardRef(function Slider2(props, forwardedRef) {
  const {
    "aria-label": ariaLabel,
  ...
  return (0, import_jsx_runtime24.jsxs)(Root, {
    ...
    children: [(0, import_jsx_runtime24.jsx)(Rail, {
      ...
      return (0, import_jsx_runtime24.jsxs)(React95.Fragment, {
...
var Snackbar = React97.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
function useTabs(parameters) {
  ...
  const onSelected = React102.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React102.useRef(() => void 0);
  const getTabPanelId = React102.useCallback((tabValue) => {
    var _a;
    return (_a = tabPanels.get(tabValue)) == null ? void 0 : _a.id;
  }, [tabPanels]);
  const getTabId2 = React102.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React102.useCallback((lookupFunction) => {
...
var TabsContext = React103.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React103.useContext(TabsContext);
  if (context == null) {
...
function TabsProvider(props) {
  ...
  const tabsContextValue = React104.useMemo(() => ({
    direction,
    getTabId: getTabId2,
    getTabPanelId,
    onSelected,
...
var Tabs = React105.forwardRef(function Tabs2(props, forwardedRef) {
  const {
    children,
    value: valueProp,
    defaultValue,
...
function useTabPanel(parameters) {
  ...
  const metadata = React106.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React107.forwardRef(function TabPanel2(props, forwardedRef) {
  const {
    children,
    value,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React108.useCallback((tabValue) => {
    var _a;
    return (_a = subitems.get(tabValue)) == null ? void 0 : _a.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React108.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React108.useCallback((tabValue) => {
    var _a;
    if (tabValue == null) {
      return null;
    }
  ...
  const handleChange = React108.useCallback((event, newValue) => {
    onSelected(event, newValue[0] ?? null);
  }, [onSelected]);
  const controlledProps = React108.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React108.useCallback((item) => {
    var _a;
  ...
  const {
    ...
    reducerActionContext: React108.useMemo(() => ({
...
function TabsListProvider(props) {
  ...
  const listContextValue = React109.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
  const compoundComponentContextValue = React109.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
...
var TabsList = React110.forwardRef(function TabsList2(props, forwardedRef) {
  const {
    children,
    slotProps = {},
    slots = {},
...
function useTab(parameters) {
  ...
  const tabRef = React111.useRef(null);
  const id = useId2(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React111.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var Tab = React112.forwardRef(function Tab2(props, forwardedRef) {
  const {
    action,
    children,
    disabled = false,
  ...
  const tabRef = React112.useRef(null);
...
var TextareaAutosize = React113.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const {
    current: isControlled
  } = React113.useRef(value != null);
  const inputRef = React113.useRef(null);
  const handleRef = useForkRef2(forwardedRef, inputRef);
  const heightRef = React113.useRef(null);
  const shadowRef = React113.useRef(null);
  const calculateTextareaStyles = React113.useCallback(() => {
  ...
  const syncHeight = React113.useCallback(() => {
  ...
  return (0, import_jsx_runtime35.jsxs)(React113.Fragment, {
...
function CssAnimation(props) {
  ...
  const hasExited = React114.useRef(true);
  React114.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React114.useCallback((event) => {
...
var CssTransition = React115.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React115.useState(false);
  React115.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React115.useCallback((event) => {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React116.useRef(false);
  const firstFocus = React116.useRef(true);
  ...
  const [focusedTag, setFocusedTag] = React116.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React116.useRef(defaultHighlighted);
  ...
  const resetInputValue = React116.useCallback((event, newValue, reason) => {
  ...
  const [inputPristine, setInputPristine] = React116.useState(true);
  ...
  const syncHighlightedIndex = React116.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React116.useRef(false);
...
var LoadingButton = React117.forwardRef(function LoadingButton2(inProps, ref) {
...
true ? LoadingButton.propTypes = {
   ...
   * @default 'center'
   */
  loadingPosition: chainPropTypes(import_prop_types37.default.oneOf(["start", "end", "center"]), (props) => {
...
var LocalizationProvider = React118.forwardRef(function DeprecatedLocalizationProvider() {
  warn15();
  return null;
});
...
var MobileDatePicker = React119.forwardRef(function DeprecatedMobileDatePicker(props, ref) {
  warn16();
  return null;
});
...
var MobileDateRangePicker = React120.forwardRef(function DeprecatedMobileDateRangePicker() {
  warn17();
  return null;
});
...
var MobileDateTimePicker = React121.forwardRef(function DeprecatedMobileDateTimePicker() {
  warn18();
  return null;
});
...
var MobileTimePicker = React122.forwardRef(function DeprecatedMobileTimePicker() {
  warn19();
  return null;
});
...
var MonthPicker = React123.forwardRef(function DeprecatedMonthPicker() {
  warn20();
  return null;
});
...
var Pagination_default2 = React124.forwardRef(function DeprecatedPagination(props, ref) {
  warn21();
...
var PaginationItem_default2 = React125.forwardRef(function DeprecatedPaginationItem(props, ref) {
  warn22();
...
var CalendarPickerSkeleton = React126.forwardRef(function DeprecatedCalendarPickerSkeleton() {
  warn23();
  return null;
});
...
var PickersDay = React127.forwardRef(function DeprecatedPickersDay() {
  warn24();
  return null;
});
...
var Rating_default2 = React128.forwardRef(function DeprecatedRating(props, ref) {
  warn25();
...
var Skeleton_default2 = React129.forwardRef(function DeprecatedSkeleton(props, ref) {
  warn26();
...
var SpeedDial_default2 = React130.forwardRef(function DeprecatedSpeedDial(props, ref) {
  warn27();
...
var SpeedDialAction_default2 = React131.forwardRef(function DeprecatedSpeedDialAction(props, ref) {
  warn28();
...
var SpeedDialIcon_default2 = React132.forwardRef(function DeprecatedSpeedDialIcon(props, ref) {
  warn29();
...
var StaticDatePicker = React133.forwardRef(function DeprecatedStaticDatePicker() {
  warn30();
  return null;
});
...
var StaticDateRangePicker = React134.forwardRef(function DeprecatedStaticDateRangePicker() {
  warn31();
  return null;
});
...
var StaticDateTimePicker = React135.forwardRef(function DeprecatedStaticDateTimePicker() {
  warn32();
  return null;
});
...
var StaticTimePicker = React136.forwardRef(function DeprecatedStaticTimePicker() {
  warn33();
  return null;
});
...
var Context = React137.createContext(null);
if (true) {
  Context.displayName = "TabContext";
}
function useUniquePrefix() {
  const [id, setId] = React137.useState(null);
  React137.useEffect(() => {
...
function useTabContext() {
  return React137.useContext(Context);
}
...
var TabList = React138.forwardRef(function TabList2(props, ref) {
  const {
...
var TabPanel3 = React139.forwardRef(function TabPanel4(inProps, ref) {
...
var TimePicker = React140.forwardRef(function DeprecatedTimePicker() {
  warn34();
  return null;
});
...
var TimelineContext = React141.createContext({});
if (true) {
...
var Timeline = React142.forwardRef(function Timeline2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeline"
  });
...
var TimelineConnector = React143.forwardRef(function TimelineConnector2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineConnector"
  });
...
var TimelineContent = React144.forwardRef(function TimelineContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineContent"
  });
  ...
  } = React144.useContext(TimelineContext_default);
  const ownerState = {
    ...props,
...
var TimelineDot = React145.forwardRef(function TimelineDot2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineDot"
  });
...
true ? TimelineDot.propTypes = {
   ...
   * @default 'grey'
   */
  color: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["error", "grey", "info", "inherit", "primary", "secondary", "success", "warning"]), import_prop_types44.default.string]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var TimelineOppositeContent = React146.forwardRef(function TimelineOppositeContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineOppositeContent"
  });
  ...
  const {
    position: positionContext
  } = React146.useContext(TimelineContext_default);
  const ownerState = {
    ...props,
...
var TimelineItem = React147.forwardRef(function TimelineItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineItem"
  });
  ...
  const {
    position: positionContext
  } = React147.useContext(TimelineContext_default);
  let hasOppositeContent = false;
  React147.Children.forEach(props.children, (child) => {
...
true ? TimelineItem.propTypes = {
   ...
   */
  position: import_prop_types46.default.oneOf(["alternate-reverse", "alternate", "left", "right"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var TimelineSeparator = React148.forwardRef(function TimelineSeparator2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineSeparator"
  });
...
var ToggleButton_default2 = React149.forwardRef(function DeprecatedToggleButton(props, ref) {
  warn35();
...
var ToggleButtonGroup_default2 = React150.forwardRef(function DeprecatedToggleButtonGroup(props, ref) {
  warn36();
...
var TreeItem = React151.forwardRef(function DeprecatedTreeItem() {
  warn37();
  return null;
});
...
var TreeView = React152.forwardRef(function DeprecatedTreeView() {
  warn38();
  return null;
});
...
function StyledEngineProvider(props) {
  ...
  return cache ? (0, import_jsx_runtime58.jsx)(CacheProvider, {
    value: cache,
    children
  }) : children;
}
true ? StyledEngineProvider.propTypes = {
   ...
   */
  enableCssLayer: import_prop_types48.default.bool,
  /**
   * By default, the styles are injected last in the <head> element of the page.
   * As a result, they gain more specificity than any other style sheet.
   * If you want to override MUI's styles, set this prop.
   */
  injectFirst: import_prop_types48.default.bool
} : void 0;
...
function GlobalStyles(props) {
  ...
  return (0, import_jsx_runtime59.jsx)(Global, {
    styles: globalStyles
  });
}
true ? GlobalStyles.propTypes = {
  defaultTheme: import_prop_types49.default.object,
  styles: import_prop_types49.default.oneOfType([import_prop_types49.default.array, import_prop_types49.default.string, import_prop_types49.default.object, import_prop_types49.default.func])
} : void 0;
...
var responsivePropType = true ? import_prop_types50.default.oneOfType([import_prop_types50.default.number, import_prop_types50.default.string, import_prop_types50.default.object, import_prop_types50.default.array]) : {};
...
function useTheme(defaultTheme4 = null) {
  const contextTheme = React155.useContext(ThemeContext);
...
function GlobalStyles2({
  ...
  return (0, import_jsx_runtime60.jsx)(GlobalStyles, {
    styles: globalStyles
  });
}
true ? GlobalStyles2.propTypes = {
   ...
   * @ignore
   */
  defaultTheme: import_prop_types52.default.object,
  /**
   * @ignore
   */
  styles: import_prop_types52.default.oneOfType([import_prop_types52.default.array, import_prop_types52.default.func, import_prop_types52.default.number, import_prop_types52.default.object, import_prop_types52.default.string, import_prop_types52.default.bool]),
  /**
   * @ignore
   */
  themeId: import_prop_types52.default.string
} : void 0;
...
function createBox(options = {}) {
  ...
  const Box2 = React157.forwardRef(function Box3(inProps, ref) {
    ...
    return (0, import_jsx_runtime61.jsx)(BoxRoot, {
      as: component,
      ref,
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match, setMatch] = React158.useState(() => {
    if (noSsr && matchMedia) {
...
var maybeReactUseSyncExternalStore = safeReact3.useSyncExternalStore;
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot = React158.useCallback(() => defaultMatches, [defaultMatches]);
  const getServerSnapshot = React158.useMemo(() => {
    if (noSsr && matchMedia) {
      return () => matchMedia(query).matches;
    }
  ...
  const [getSnapshot, subscribe] = React158.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
function ThemeProvider(props) {
  ...
  return (0, import_jsx_runtime62.jsx)(ThemeContext_default.Provider, {
    value: theme,
    children
  });
}
...
function RtlProvider({
  ...
  return (0, import_jsx_runtime63.jsx)(RtlContext.Provider, {
    value: value ?? true,
    ...props
  });
}
...
function DefaultPropsProvider({
  ...
  return (0, import_jsx_runtime64.jsx)(PropsContext.Provider, {
    value,
    children
  });
}
...
function ThemeProvider2(props) {
  ...
  return (0, import_jsx_runtime65.jsx)(ThemeProvider_default, {
    theme: privateTheme,
    children: (0, import_jsx_runtime65.jsx)(ThemeContext.Provider, {
      value: engineTheme,
      children: (0, import_jsx_runtime65.jsx)(RtlProvider_default, {
        value: rtlValue,
        children: (0, import_jsx_runtime65.jsx)(DefaultPropsProvider_default, {
...
function createContainer(options = {}) {
  ...
  const Container2 = React168.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime68.jsx)(ContainerRoot, {
        as: component,
        ownerState,
        className: clsx_default(classes.root, className),
        ref,
...
function createGrid(options = {}) {
  ...
  const Grid2 = React169.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime69.jsx)(GridRoot, {
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ...
      children: React169.Children.map(children, (child) => {
        var _a;
        if (React169.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function joinChildren(children, separator) {
  const childrenArray = React170.Children.toArray(children).filter(Boolean);
  return childrenArray.reduce((output, child, index2) => {
    output.push(child);
    if (index2 < childrenArray.length - 1) {
      output.push(React170.cloneElement(separator, {
...
function createStack(options = {}) {
  ...
  const Stack2 = React170.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
    ...
    return (0, import_jsx_runtime70.jsx)(StackRoot, {
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className),
...
var Masonry = React171.forwardRef(function Masonry2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React171.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React171.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React171.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = {
    ...props,
    spacing: spacing2,
    columns,
  ...
  const handleResize = React171.useCallback((masonryChildren) => {
  ...
  const lineBreaks = new Array(numberOfLineBreaks).fill("").map((_, index2) => (0, import_jsx_runtime71.jsx)("span", {
  ...
  return (0, import_jsx_runtime71.jsxs)(MasonryRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    ref: handleRef,
    ownerState,
